<div class="basement">
    <div data-echo-options="{{ json_encode($echoOptions) }}" x-ref="basementChatBox" x-data="basementChatBox"
        ...
        @class([
            ...
            'bm-bottom-3 bm-left-3' => \Omniax\basement_chatBot\Enums\ChatBoxPosition::bottomLeft()->equals(
                $position),
            'bm-bottom-3 bm-right-3' => \Omniax\basement_chatBot\Enums\ChatBoxPosition::bottomRight()->equals(
                $position),
        ])>
        ...
        <button
            ...
            x-on:click="isMinimized = false" x-bind:class="isMinimized === true ? '' : 'bm-hidden'"
            ...
            <template x-if="totalUnreadMessages > 0">
                <span class="bm-animate-pulse bm-text-xl bm-font-extrabold"
                    x-text="totalUnreadMessages > 99 ? '99+' : totalUnreadMessages"></span>
            </template>
        </button>

        <div class="bm-hidden bm-h-full bm-w-full" x-bind:class="isMinimized === true ? '' : '!bm-block'">
