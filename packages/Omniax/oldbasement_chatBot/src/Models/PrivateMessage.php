...
namespace Omniax\basement_chatBot\Models;

use Omniax\basement_chatBot\Casts\AsMessageType;
 ...
 * @property \Omniax\basement_chatBot\Enums\MessageType $type
 * @property string $value
 * @property \Illuminate\Support\Carbon $created_at
 * @property \Illuminate\Support\Carbon|null $read_at
 *
 * @method static \Omniax\basement_chatBot\Database\Factories\PrivateMessageFactory factory(...$parameters)
...
class PrivateMessage extends Model
{
     ...
     *
     * @param  \Illuminate\Database\Eloquent\Builder<PrivateMessage>  $query
     * @param  \Illuminate\Foundation\Auth\User&\Omniax\basement_chatBot\Contracts\User $a
     * @param  \Illuminate\Foundation\Auth\User&\Omniax\basement_chatBot\Contracts\User $b
     */
