...
namespace Omniax\basement_chatBot\Http\Requests;
...
class UpdatePrivateMessagesRequest extends FormRequest
{
     ...
     *
     * @var \Illuminate\Support\Collection<int,\Omniax\basement_chatBot\Data\PrivateMessageData>
     */
    ...
    protected function validateMarkAsReadOperation(Validator $validator): void
    {
        ...
        /** @var \Illuminate\Support\Collection<int,\Omniax\basement_chatBot\Data\PrivateMessageData> $privateMessages */
